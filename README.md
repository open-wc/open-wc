...
Open-wc provides a set of recommendations and defaults on how to facilitate your web component project, our recommendations include: developing, linting, testing, tooling, demoing, publishing and automating.
