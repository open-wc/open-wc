...
export const getGlobalRegistryMixinImplementation = () => {
  /**
   * Template caches
   *
  ...
  const GlobalRegistryMixinImplementation = superclass =>
  ...
  return dedupeMixin(GlobalRegistryMixinImplementation);
};
