...
import { defineCustomElements } from './stencil-el/es2017/mycomponent.define.js';

class TestComponent extends HTMLElement {}
customElements.define('test-component', TestComponent);

// register stencil component
...
describe('stringFixtureSync & litFixtureSync & fixture & litFixture', () => {
  ...
  it('will wait for an componentOnReady promise if it is available', async () => {
    const el = await litFixture(
      html`
        <my-component .first=${'John'}></my-component>
      `,
    );
    expect(el.shadowRoot.querySelector('div').innerText).to.equal("Hello, World! I'm John");
  });
});
