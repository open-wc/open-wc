 ...
 */
describe.skip('reload browser middleware with default watch options', function defaultWatchOptions() {
  let server;
  this.timeout(60000);
  beforeEach(async () => {
...
describe.skip('reload browser middleware with custom watch options', function customWatchOptions() {
  let server;
  this.timeout(60000);
  beforeEach(async () => {
    ({ server } = await startServer({
